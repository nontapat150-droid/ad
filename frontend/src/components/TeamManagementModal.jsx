              ...
              {teams.map(team => (
                <div key={team.id} className="bg-white p-4 rounded-2xl border border-slate-100 shadow-sm hover:shadow-md transition-all flex items-center justify-between group">
                  ...
                  <button
                    ...
                    className="p-2.5 rounded-xl bg-red-50 hover:bg-red-100 text-red-500 opacity-0 group-hover:opacity-100 transition-all disabled:opacity-50 disabled:cursor-not-allowed"
